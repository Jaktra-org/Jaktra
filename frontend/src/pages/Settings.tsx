        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          {wizardStep === 3 && (
            <div className="space-y-5">
              ...
              <div className="space-y-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (val.includes('@')) {
                      setInboundDomainErr('Inbound reply domain cannot be an email address. Enter a domain name such as reply.acme.com.');
                    } else {
                      setInboundDomainErr('');
                    }
                  }}
              ...
              {/* Actionable DNS Record Card */}
              <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-lg space-y-3">
                <div className="flex items-center justify-between">
                  <h5 className="text-xs font-bold text-slate-900">Required Inbound DNS Record</h5>
                  <span className="text-[11px] text-slate-500 font-medium">One-Time Onboarding Check</span>
                </div>
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border border-slate-200 bg-white rounded-md">
                    ...
                    <tbody className="divide-y divide-slate-100 font-mono text-[11px]">
                      <tr>
                        <td className="px-3 py-2 text-slate-900 font-bold">{inboundDomainInput.trim() || 'reply.acme.com'}</td>
                        <td className="px-3 py-2 font-semibold text-blue-700">MX</td>
                        ...
                        <td className="px-3 py-2">
                          {isVerified ? (
                            ...
                            <span className="text-amber-700 font-sans font-medium">⏳ Pending MX</span>
                          )}
                        </td>
                      </tr>
                    </tbody>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md text-xs font-semibold shrink-0 transition-colors disabled:opacity-50 flex items-center"
                  >
                    {verifyInboundWebhookMutation.isPending && <Loader2 className="w-3.5 h-3.5 mr-1.5 animate-spin" />}
                    {verifyInboundWebhookMutation.isPending ? 'Verifying...' : 'Re-check DNS & Webhook'}
                  </button>
                  <button
                    type="button"
              ...
              {/* Multi-Tenant Virtual Sub-Addressing Copy Explanation */}
              <div className="p-3.5 bg-blue-50/70 border border-blue-200 rounded-md space-y-2 text-xs text-blue-900">
                <div className="flex items-center justify-between font-bold text-blue-950">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-700 hover:text-blue-900 font-semibold inline-flex items-center text-[11px]"
                  >
                ...
                <ul className="list-disc list-inside space-y-1 text-[11px] text-blue-800 leading-relaxed">
                  ...
                  <li><strong>Dynamic Virtual Addresses:</strong> Jaktra generates unique virtual reply addresses (e.g. <code>r_f8QkL9Xn...@reply.acme.com</code>).</li>
                  <li><strong>One-Time Domain Setup:</strong> SMTP routes all replies using the MX record of <code>{inboundDomainInput.trim() || 'reply.acme.com'}</code>. Once verified, millions of reply addresses under this domain are valid automatically.</li>
