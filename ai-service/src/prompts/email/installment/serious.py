...
_SYSTEM = (
    ...
    "2. Tone: Urgent, formal, and authoritative. Do not use conversational filler or pleasantries.\n"
    "3. Context: State Invoice #{invoice_no}, integrating the goods or services ({invoice_description}) naturally and grammatically. State Installment #{installment_number} of {total_installments}, amount ({currency}{formatted_amount}), due date was {human_due_date}, and overdue duration ({overdue_phrase}). Do not label this email by notice count or assume prior communications.\n"
